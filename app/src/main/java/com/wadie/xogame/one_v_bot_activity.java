...
public class one_v_bot_activity extends Activity {
    private Button btn_00, btn_01, btn_02, btn_10, btn_11, btn_12, btn_20, btn_21, btn_22, btn_back;
    private Button[] activeBtns;
    private int turn = 0;
    private PlayAction playAction;

    public one_v_bot_activity() {
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(v -> {
            Intent intent = new Intent(one_v_bot_activity.this, main_activity.class);
            startActivity(intent);
        });
        activeBtns = new Button[]{btn_00, btn_01, btn_02, btn_10, btn_11, btn_12, btn_20, btn_21, btn_22};
    ...
    public Button[] getActiveBtns() {
        return activeBtns;
    }

    public void removeActiveBtn(int index) {
        activeBtns[index] = null;
        turn++;
    }
    public int getTurn() {
        return turn;
